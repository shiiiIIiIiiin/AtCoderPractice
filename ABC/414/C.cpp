...
int main() {
    ...
    for (ll i = 1; i <= 1000000; i++) {
        ...
        ll u = i * modpow(10LL, n, LLONG_MAX / 2) + k;
        ...
        ll u2 = i * modpow(10LL, n2, LLONG_MAX / 2) + k2;

        kaibun_num.insert(u2);
    }

    ll ans = 0;

    for (auto x : kaibun_num) {
        if (x > N)break;
        if (check(x, A))ans += x;
    }
