...
int main() {
    int N; cin >> N;
    vector<vector<ll>> imos(1510, vector<ll>(1510, 0));
    ...
    for (int j = 0; j < 1510; j++)for (int i = 1; i < 1510; i++)imos[i][j] += imos[i - 1][j];
    for (int i = 0; i < 1510; i++)for (int j = 1; j < 1510; j++)imos[i][j] += imos[i][j - 1];

    int ans = 0;

    for (int i = 0; i < 1510; i++)for (int j = 0; j < 1510; j++)if (imos[i][j] >= 1)ans++;
